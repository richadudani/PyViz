...
In this section, you will calculate the number of dwelling types per year (sum) and visualize the results as a bar chart using the Pandas plot function.
...
#### Cost Analysis (Optional Challenge - See Rubric for point allocation)
